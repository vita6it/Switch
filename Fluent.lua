...
local aa = {
    ...
    [28] = function()
        ...
        return {
            assets = {
                ...
                ["lucide-sortasc"] = "rbxassetid://10734965115",
    ...
    [49] = function()
        ...
        return _G.Config_Ui or {
            Name = "Aqua",
            Accent = Color3.fromRGB(68, 202, 186),
            AcrylicMain = Color3.fromRGB(0, 0, 0),
            AcrylicBorder = Color3.fromRGB(68, 202, 186),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(68, 202, 186), Color3.fromRGB(0, 0, 0)),
            AcrylicNoise = 0.9,
            TitleBarLine = Color3.fromRGB(68, 202, 186),
            Tab = Color3.fromRGB(68, 202, 186),
            Element = Color3.fromRGB(68, 202, 186),
            ElementBorder = Color3.fromRGB(68, 202, 186),
            InElementBorder = Color3.fromRGB(68, 202, 186),
            ElementTransparency = 0.84,
            ToggleSlider = Color3.fromRGB(68, 202, 186),
            ToggleToggled = Color3.fromRGB(0, 0, 0),
            SliderRail = Color3.fromRGB(68, 202, 186),
            DropdownFrame = Color3.fromRGB(68, 202, 186),
            DropdownHolder = Color3.fromRGB(0, 0, 0),
            DropdownBorder = Color3.fromRGB(68, 202, 186),
            DropdownOption = Color3.fromRGB(68, 202, 186),
            Keybind = Color3.fromRGB(68, 202, 186),
            Input = Color3.fromRGB(68, 202, 186),
            InputFocused = Color3.fromRGB(0, 0, 0),
            InputIndicator = Color3.fromRGB(68, 202, 186),
            Dialog = Color3.fromRGB(0, 0, 0),
            DialogHolder = Color3.fromRGB(0, 0, 0),
            DialogHolderLine = Color3.fromRGB(68, 202, 186),
            DialogButton = Color3.fromRGB(68, 202, 186),
            DialogButtonBorder = Color3.fromRGB(68, 202, 186),
            DialogBorder = Color3.fromRGB(68, 202, 186),
            DialogInput = Color3.fromRGB(0, 0, 0),
            DialogInputLine = Color3.fromRGB(68, 202, 186),
            Text = Color3.fromRGB(255, 255, 255),
            SubText = Color3.fromRGB(150, 150, 150),
            Hover = Color3.fromRGB(68, 202, 186),
            HoverChange = 0.04
        }
    end,
    [50] = function()
